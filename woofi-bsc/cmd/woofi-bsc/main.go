...
func main() {
	...
	m := woofi.New(c, conf)
	m.AddContract(WooPPV1.NewContract("0x10C24658815585851a8888f059Cb4338790023F1"))
	m.AddContract(WooPPV2.NewContract("0x8489d142Da126F4Ea01750e80ccAa12FD1642988"))
	m.AddContract(WooRouterV1.NewContract("0x114f84658c99aa6EA62e3160a87A16dEaF7EFe83"))
	m.AddContract(WooRouterV2.NewContract("0xcEf5BE73ae943B77f9Bc08859367D923C030a269"))
	m.AddContract(WooCrossChainRouterV1.NewContract("0x53E255e8Bbf4EDF16797f9885291B3Ca0C70B59f"))
	m.Start()
}
