...
// Sin is a free data retrieval call binding the contract method 0xd0adc35f.
//
// Solidity: function Sin() view returns(uint256)
func (_MCDVOW *MCDVOWCaller) Sin(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function Sin() view returns(uint256)
func (_MCDVOW *MCDVOWSession) Sin() (*big.Int, error) {
	return _MCDVOW.Contract.Sin(&_MCDVOW.CallOpts)
}

// Sin is a free data retrieval call binding the contract method 0xd0adc35f.
//
// Solidity: function Sin() view returns(uint256)
func (_MCDVOW *MCDVOWCallerSession) Sin() (*big.Int, error) {
	return _MCDVOW.Contract.Sin(&_MCDVOW.CallOpts)
}
...
// Sin2 is a free data retrieval call binding the contract method 0xcb5cc109.
//
// Solidity: function sin(uint256 ) view returns(uint256)
func (_MCDVOW *MCDVOWCaller) Sin2(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function sin(uint256 ) view returns(uint256)
func (_MCDVOW *MCDVOWSession) Sin2(arg0 *big.Int) (*big.Int, error) {
	return _MCDVOW.Contract.Sin2(&_MCDVOW.CallOpts, arg0)
}

// Sin2 is a free data retrieval call binding the contract method 0xcb5cc109.
//
// Solidity: function sin(uint256 ) view returns(uint256)
func (_MCDVOW *MCDVOWCallerSession) Sin2(arg0 *big.Int) (*big.Int, error) {
	return _MCDVOW.Contract.Sin2(&_MCDVOW.CallOpts, arg0)
}
