...
func (_MCDVESTDAI *MCDVESTDAITransactor) Deny(opts *bind.TransactOpts, usr common.Address) (*types.Transaction, error) {
	return _MCDVESTDAI.contract.Transact(opts, "deny", usr)
}

// Deny is a paid mutator transaction binding the contract method 0x9c52a7f1.
//
// Solidity: function deny(address usr) returns()
func (_MCDVESTDAI *MCDVESTDAISession) Deny(usr common.Address) (*types.Transaction, error) {
	return _MCDVESTDAI.Contract.Deny(&_MCDVESTDAI.TransactOpts, usr)
}

// Deny is a paid mutator transaction binding the contract method 0x9c52a7f1.
//
// Solidity: function deny(address usr) returns()
func (_MCDVESTDAI *MCDVESTDAITransactorSession) Deny(usr common.Address) (*types.Transaction, error) {
	return _MCDVESTDAI.Contract.Deny(&_MCDVESTDAI.TransactOpts, usr)
}
...
func (_MCDVESTDAI *MCDVESTDAITransactor) Rely(opts *bind.TransactOpts, usr common.Address) (*types.Transaction, error) {
	return _MCDVESTDAI.contract.Transact(opts, "rely", usr)
}

// Rely is a paid mutator transaction binding the contract method 0x65fae35e.
//
// Solidity: function rely(address usr) returns()
func (_MCDVESTDAI *MCDVESTDAISession) Rely(usr common.Address) (*types.Transaction, error) {
	return _MCDVESTDAI.Contract.Rely(&_MCDVESTDAI.TransactOpts, usr)
}

// Rely is a paid mutator transaction binding the contract method 0x65fae35e.
//
// Solidity: function rely(address usr) returns()
func (_MCDVESTDAI *MCDVESTDAITransactorSession) Rely(usr common.Address) (*types.Transaction, error) {
	return _MCDVESTDAI.Contract.Rely(&_MCDVESTDAI.TransactOpts, usr)
}
