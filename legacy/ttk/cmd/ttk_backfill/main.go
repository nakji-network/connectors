...
// go run ./connectors/source/ttk/cmd/ttk_backfill/main.go --fromBlock 11945500 --toBlock 11945502
package main
...
func main() {
	...
	for evLog := range logsChan {
		...
		msg := connector.TtkLogToMsg(evLog)
