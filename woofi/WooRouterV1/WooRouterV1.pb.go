...
// 	protoc        v3.21.8
// source: WooRouterV1/WooRouterV1.proto
...
func (x *OwnershipTransferred) Reset() {
	*x = OwnershipTransferred{}
	if protoimpl.UnsafeEnabled {
		mi := &file_WooRouterV1_WooRouterV1_proto_msgTypes[0]
...
func (*OwnershipTransferred) Descriptor() ([]byte, []int) {
	return file_WooRouterV1_WooRouterV1_proto_rawDescGZIP(), []int{0}
}
...
func (x *WooPoolChanged) Reset() {
	*x = WooPoolChanged{}
	if protoimpl.UnsafeEnabled {
		mi := &file_WooRouterV1_WooRouterV1_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WooPoolChanged) Descriptor() ([]byte, []int) {
	return file_WooRouterV1_WooRouterV1_proto_rawDescGZIP(), []int{1}
}
...
func (x *WooRouterSwap) Reset() {
	*x = WooRouterSwap{}
	if protoimpl.UnsafeEnabled {
		mi := &file_WooRouterV1_WooRouterV1_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WooRouterSwap) Descriptor() ([]byte, []int) {
	return file_WooRouterV1_WooRouterV1_proto_rawDescGZIP(), []int{2}
}
...
var File_WooRouterV1_WooRouterV1_proto protoreflect.FileDescriptor

var file_WooRouterV1_WooRouterV1_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x57, 0x6f, 0x6f, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x56, 0x31, 0x2f, 0x57, 0x6f,
	0x6f, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x56, 0x31, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x0b, 0x57, 0x6f, 0x6f, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x56, 0x31, 0x1a, 0x1f, 0x67, 0x6f,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x6e, 0x65, 0x77, 0x50, 0x6f, 0x6f, 0x6c, 0x22, 0xbf, 0x02,
	...
	0x0e, 0x0a, 0x02, 0x74, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x74, 0x6f, 0x42,
	0x25, 0x5a, 0x23, 0x62, 0x6c, 0x65, 0x70, 0x2e, 0x61, 0x69, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x2f,
	0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x2f, 0x57, 0x6f, 0x6f, 0x52, 0x6f,
	0x75, 0x74, 0x65, 0x72, 0x56, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_WooRouterV1_WooRouterV1_proto_rawDescOnce sync.Once
	file_WooRouterV1_WooRouterV1_proto_rawDescData = file_WooRouterV1_WooRouterV1_proto_rawDesc
)

func file_WooRouterV1_WooRouterV1_proto_rawDescGZIP() []byte {
	file_WooRouterV1_WooRouterV1_proto_rawDescOnce.Do(func() {
		file_WooRouterV1_WooRouterV1_proto_rawDescData = protoimpl.X.CompressGZIP(file_WooRouterV1_WooRouterV1_proto_rawDescData)
	})
	return file_WooRouterV1_WooRouterV1_proto_rawDescData
}

var file_WooRouterV1_WooRouterV1_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_WooRouterV1_WooRouterV1_proto_goTypes = []interface{}{
...
var file_WooRouterV1_WooRouterV1_proto_depIdxs = []int32{
...
func init() { file_WooRouterV1_WooRouterV1_proto_init() }
func file_WooRouterV1_WooRouterV1_proto_init() {
	if File_WooRouterV1_WooRouterV1_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_WooRouterV1_WooRouterV1_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_WooRouterV1_WooRouterV1_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_WooRouterV1_WooRouterV1_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_WooRouterV1_WooRouterV1_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_WooRouterV1_WooRouterV1_proto_goTypes,
		DependencyIndexes: file_WooRouterV1_WooRouterV1_proto_depIdxs,
		MessageInfos:      file_WooRouterV1_WooRouterV1_proto_msgTypes,
	}.Build()
	File_WooRouterV1_WooRouterV1_proto = out.File
	file_WooRouterV1_WooRouterV1_proto_rawDesc = nil
	file_WooRouterV1_WooRouterV1_proto_goTypes = nil
	file_WooRouterV1_WooRouterV1_proto_depIdxs = nil
}
